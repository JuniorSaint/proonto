...
public class BanksController {
    ...
    @PostMapping
    public ResponseEntity<BankResponseId> save(@RequestBody @Valid BankRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(service.saveUpdate(request));
    }
    @PutMapping
    public ResponseEntity<BankResponseId> update(@RequestBody @Valid BankRequest request) {
