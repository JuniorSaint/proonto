...
public interface ImmovableMock {
    ...
    public static final String RG = "M365.365.356";
    public static final String CPF_IMMOVABLE = "88288895168";
    public static final String MARITAL_STATUS = "casado";
    public static final String CNS = "cns";
    public static final String BOOK = "book 23";
    public static final String REGISTRATION_NUMBER_TRANSCRIPT = "book 23";
